...
void RepairTicketSonar::on_pushButton_clicked()
{
    ...
    QString line3 = cstName + "\n";// + cstID;

    /*checkNA(cstAddress);
    QString line4 = cstAddress;

    checkNA(cstCty);
    QString line5 = cstCty;
    ...
    if(error == false)
    {
        ...
        //ui->ticketTemplate->append(line4);                // Removed per Joey for build 2.0
        //ui->ticketTemplate->append(line5);                // Removed per Joey for build 2.0
        //ui->ticketTemplate->append(line6);                // Removed per Joey for build 2.0
        //ui->ticketTemplate->append(line7);                // Removed per Joey for build 2.0
        //ui->ticketTemplate->append(line8);                // Removed per Joey for build 2.0
        ...
        //ui->ticketTemplate->append(line37);               // Removed per Joey for build 2.0
          ...
          ui->ticketTemplate->append(line38);               // Removed per Joey for build 2.0
...
void RepairTicketSonar::checkNA(QString &string)
{
    if(string == "")
        string = "--";
    else if(string == "What was done on the call? Include the customer's attude. Were they tech savy or not?")
        string = "--";
}
...
bool RepairTicketSonar::checkImportantInfo()
{
    ...
    // Check for ticket creator's name.
    /*if(ui->tktName->currentText() == "")
    {


        ui->ticketTemplate->append("\"Tech Creating the Ticket:\" Needs to be selected.");
        return true;
    }*/
